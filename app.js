...
mongoose.connect("mongodb+srv://admin-USERNAME:PASSWORD@cluster0.s1nr6vc.mongodb.net/blogDB").then(() => console.log("MongoDb database Connected!")).catch((error) => console.log(error.reason));
